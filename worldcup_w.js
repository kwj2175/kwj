    ...
    _O.Ctrl = {
      getLists() {
        return [
          {
            name: '이동욱',
            imgSrc: 'images_w/01.jpg',
            selected: false
          },
          {
            name: '박서준',
            imgSrc: 'images_w/02.jpg',
            selected: false
          },
          {
            name: '안보현',
            imgSrc: 'images_w/03.jpg',
            selected: false
          },
          {
            name: '서강준',
            imgSrc: 'images_w/04.jpg',
            selected: false
          },
          {
            name: '김선호',
            imgSrc: 'images_w/05.jpg',
            selected: false
          },
          {
            name: '차은우',
            imgSrc: 'images_w/06.jpg',
            selected: false
          },
          {
            name: '이민호',
            imgSrc: 'images_w/07.jpg',
            selected: false
          },
          {
            name: '우도환',
            imgSrc: 'images_w/08.jpg',
            selected: false
          },
          {
            name: '정해인',
            imgSrc: 'images_w/09.jpg',
            selected: false
          },
          {
            name: '남주혁',
            imgSrc: 'images_w/10.jpg',
            selected: false
          },
          {
            name: '박보검',
            imgSrc: 'images_w/11.jpg',
            selected: false
          },
          {
            name: '최우식',
            imgSrc: 'images_w/12.jpg',
            selected: false
          },
          {
            name: '김수현',
            imgSrc: 'images_w/13.jpg',
            selected: false
          },
          {
            name: '여진구',
            imgSrc: 'images_w/14.jpg',
            selected: false
          },
          {
            name: '현빈',
            imgSrc: 'images_w/15.jpg',
            selected: false
          },
          {
            name: '임시완',
            imgSrc: 'images_w/16.jpg',
            selected: false
          }
        ];
      },
    ...
    _O.Html = {
      ...
      getItem() {
        ...
        for(i; i < length && length <= _O.Vars.curRound; i++) {
          s += `
          <li>
            <a class="item ${_O.Vars.curRound === 1 ? 'final' : ''}" id="item_${i}" hover="false" href="javascript:void(0);" onclick="worldcup_w.Event.clickItem(this);" onmouseover="worldcup_w.Event.overItem(this);" onmouseout="worldcup_w.Event.outItem(this);">
